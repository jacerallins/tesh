...
const bridge: TeshBridge = {
  ...
  speakerVerification: {
    isConfigured: () => ipcRenderer.invoke('voice:speaker-configured'),
    isEnrolled: () => ipcRenderer.invoke('voice:speaker-enrolled'),
    enrollFromFiles: () => ipcRenderer.invoke('voice:speaker-enroll-files'),
    clearEnrollment: () => ipcRenderer.invoke('voice:speaker-clear'),
