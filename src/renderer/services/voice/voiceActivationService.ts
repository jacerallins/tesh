...
export const defaultVerificationConfiguration: VerificationConfiguration = { wakePhrase: import.meta.env.VITE_TESH_WAKE_PHRASE ?? 'Tesh', confidenceThreshold: 0.82, failedAttemptLimit: 3, backoffMs: 15000, sessionTimeoutMs: 15 * 60 * 1000, requiredEnrollmentSamples: 3 };
