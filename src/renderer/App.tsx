...
function FirstRunSetup({ onFinish, visualState }: { onFinish: () => void; visualState: TeshVisualStateController }): ReactElement {
  ...
  const nativeVoice = !visualState.activationSnapshot.mock;
